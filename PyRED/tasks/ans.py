...
class ANSLoader(TaskLoader):
    
    """Class to process files from the RED ANS task.
    """
    
    def __init__(self, data_dir, output_path=None, task_name="ANS_MainTask"):
        
        """Initialises a new ANSLoader instance to read and process data
        from files generated by the RED numerosity task.
    ...
    def load_from_file(self, file_path, delimiter=",", missing=None, \
        ...
        raw = read_behaviour(file_path, delimiter=",", missing=None, \
            auto_typing=True, string_vars=["LeftStimuliName", \
                "RightStimuliName", "ResponseSide", "ResponseCorrect"])
    ...
    def process_raw_data(self):
        ...
        for i, ppname in enumerate(participants):
            ...
            self.data["n_correct"][i]   = numpy.sum(self.raw[ppname]["ResponseCorrect"])
