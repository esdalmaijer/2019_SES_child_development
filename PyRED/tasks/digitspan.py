...
class DigitSpanLoader(TaskLoader):
    
    """Class to process files from the RED Digit Span task.
    """
    
    def __init__(self, data_dir, output_path=None, task_name="Digit_Span"):
        
        """Initialises a new DotMatrixLoader instance to read and process data
        from files generated by the RED digit span task.
