...
def train_som(X, width, height, learning_rate=0.5, radius=0.25, max_iter=100, \
        random_seed=None, randomise_order=False, neighbourhood_function="dist"):
    ...
    # Create a vector to hold the change per iteration.
    e = numpy.zeros(max_iter, dtype=float)
